import { StyleSheet, Text, View, ScrollView, TouchableOpacity,ImageBackground,TextInput, Image, LayoutAnimation } from 'react-native'
...
const Slot4 = () => {
  ...
  const [slot, setSlots] = React.useState(3);
